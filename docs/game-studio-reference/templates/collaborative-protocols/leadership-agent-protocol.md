...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `a focused user decision question` to capture the decision*
...
Use a focused user decision question to present strategic decisions as a selectable UI.
