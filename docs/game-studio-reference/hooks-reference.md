...
| ---- | ----- | ------- | ------ |
| `validate-commit.sh` | PreToolUse (shell) | `git commit` commands | Validates design doc sections, JSON data files, hardcoded values, TODO format |
| `validate-push.sh` | PreToolUse (shell) | `git push` commands | Warns on pushes to protected branches (develop/main) |
...
Hook reference documentation: `docs/game-studio-reference/hooks-reference/`
Hook input schema documentation: `docs/game-studio-reference/hooks-reference/hook-input-schemas.md`
