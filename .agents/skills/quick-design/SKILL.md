...
Present the inferred classification using `a focused user decision question`:
...
Present the draft to the user in full. Then use `a focused user decision question`:
