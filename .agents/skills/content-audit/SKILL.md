---
name: content-audit
description: "Audit GDD-specified content counts against implemented content. Identifies what's planned vs built. 当用户明确点名该流程或当前任务与其专业目标直接匹配时使用；不用于无关的一般开发任务。"
---
...
2. **L0 pre-scan**: Before full-reading any GDDs, `rg` text search all GDD files for
   `## Summary` sections plus common content-count keywords:
   ```
   `rg` text search pattern="(## Summary|N enemies|N levels|N items|N abilities|enemy types|item types)" glob="design/gdd/*.md" output_mode="files_with_matches"
   ```
...
what has been implemented. Use file search and `rg` text search to locate files.

**Levels / Areas / Maps:**
- file search `assets/**/*.tscn`, `assets/**/*.unity`, `assets/**/*.umap`
- file search `src/**/*.tscn`, `src/**/*.unity`
...
- file search `assets/data/**/enemies/**`, `assets/data/**/characters/**`
- file search `src/**/enemies/**`, `src/**/characters/**`
...
- file search `assets/data/**/items/**`, `assets/data/**/equipment/**`,
  `assets/data/**/loot/**`
- Look for `.json`, `.tres`, `.asset` data files

**Abilities / Skills / Spells:**
- file search `assets/data/**/abilities/**`, `assets/data/**/skills/**`,
  `assets/data/**/spells/**`
- Look for `.json`, `.tres`, `.asset` data files

**Dialogue / Conversations / Cutscenes:**
- file search `assets/**/*.dialogue`, `assets/**/*.csv`, `assets/**/*.ink`
- `rg` text search for dialogue data files in `assets/data/`

**Quests / Missions:**
- file search `assets/data/**/quests/**`, `assets/data/**/missions/**`
